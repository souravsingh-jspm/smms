...
const contactInfo = [
  ...
  },
  {
    ...
    title: "Phone",
    content: [
      "+91 20 2680 1000 (Main)",
      "+91 20 2680 1001 (Conference Office)",
      "+91 20 2680 1002 (Registration)",
    ],
  },
  {
    icon: Mail,
  ...
  },
  {
    ...
    content: [
      ...
      "Sunday: Closed",
      "Conference Support: 24/7 during event",
    ],
  },
];
      ...
      <section className="bg-gradient-to-r from-conference-blue to-conference-blue/80 text-white py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-blue-100 max-w-3xl mx-auto">
            Get in touch with us for any questions about ICETMMS 2024
          </p>
        </div>
      </section>
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            <div>
              <Card className="border-conference-blue/20">
                <CardHeader>
                  <CardTitle className="text-2xl text-conference-blue">
                    Send us a Message
                  </CardTitle>
                ...
                <CardContent>
                  <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <Button
                      type="submit"
                      className="w-full bg-conference-red hover:bg-conference-red/90 text-white font-semibold"
                      size="lg"
                    >
                ...
                <Card key={index} className="border-conference-blue/20">
                  <CardContent className="p-6">
                    <div className="flex items-start space-x-4">
                      <div className="w-12 h-12 bg-conference-blue rounded-full flex items-center justify-center flex-shrink-0">
                        <info.icon className="w-6 h-6 text-white" />
                      </div>
                      <div>
                        <h3 className="text-lg font-semibold text-conference-blue mb-2">
                          {info.title}
                        </h3>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600">
              Direct contact with our team members
            </p>
          </div>
                ...
                <CardContent className="text-center space-y-2">
                  ...
                  <p className="text-sm text-gray-600">
                    ...
                    <a
                      ...
                      className="text-conference-blue hover:underline"
                    >
                      {contact.email}
                    </a>
                  </p>
